...
const PrivacyPolicy = () => {
  return (
    <div className='privacy-policy'>
      ...
      <h1 className='privacy-policy__header'>Interpretation and Definitions</h1>
      <h2 className='privacy-policy__header'>Interpretation</h2>
      <p>
      ...
      <h2 className='privacy-policy__header'>Definitions</h2>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            "Us" or "Our" in this Agreement) refers to CJAtkins.co.uk.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to CJAtkins.co.uk, accessible from
            <a
              href='https://www.cjatkins.co.uk'
              rel='external nofollow noopener'
              target='_blank'
            >
              https://www.cjatkins.co.uk
            </a>
          </p>
        </li>
        <li>
      ...
      <h1 className='privacy-policy__header'>
        Collecting and Using Your Personal Data
      </h1>
      <h2 className='privacy-policy__header'>Types of Data Collected</h2>
      <h3 className='privacy-policy__header'>Personal Data</h3>
      <p>
      ...
      <h3 className='privacy-policy__header'>Usage Data</h3>
      ...
      <h3 className='privacy-policy__header'>
      ...
      <h2 className='privacy-policy__header'>Use of Your Personal Data</h2>
      ...
      <h2 className='privacy-policy__header'>Transfer of Your Personal Data</h2>
      <p>
      ...
      <h3 className='privacy-policy__header'>Business Transactions</h3>
      <p>
      ...
      <h3 className='privacy-policy__header'>Law enforcement</h3>
      <p>
        Under certain circumstances, the Company may be required to disclose
        Your Personal Data if required to do so by law or in response to valid
        requests by public authorities (e.g. a court or a government agency).
      </p>
      <h3 className='privacy-policy__header'>Other legal requirements</h3>
      <p>
      ...
      <h2 className='privacy-policy__header'>Security of Your Personal Data</h2>
      <p>
      ...
      <h1 className='privacy-policy__header'>Children's Privacy</h1>
      <p>
      ...
      <h1 className='privacy-policy__header'>Links to Other Websites</h1>
      <p>
      ...
      <h1 className='privacy-policy__header'>Changes to this Privacy Policy</h1>
      <p>
      ...
      <h1 className='privacy-policy__header'>Contact Us</h1>
      <p>
      ...
      <ul>
        <li>
          Via email:
          <a href='mailto:contact@cjatkins.co.uk'>contact@cjatkins.co.uk</a>
        </li>
      </ul>
    </div>
  );
